...
<!-- Nav tabs -->
 <ul class="nav nav-tabs nav-justified md-tabs indigo" id="myTabJust" role="tablist">
     <li class="nav-item">
         <a class="nav-link active" id="tab1" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-eye"></i> View Dosage Instruction</a>
     </li> 
     <li class="nav-item">
         <a class="nav-link" id="tab2" data-toggle="tab" href="#panel6" role="tab"><i class="fa fa-pencil"></i> Add Dosage Instruction</a>
     </li>
         ...
         $row=$admin->getAllInstruction();
              foreach ($row as $instruction_data) {
                ...
                <tr class="text-center">
                  <td><?php echo $instruction_data['instruction_id']; ?></td>
                   <td><?php echo $instruction_data['instruction']; ?></td>
                 
                  
                  <td>
                    <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#centralModalDanger" onclick="remove_instruction_modal('Remove','<?php echo $instruction_data['instruction_id'];?>')" >Remove</a></td>
                </tr>
                <?php
              }
...
<div class="md-form  col-lg-3 offset-md-4">
      ...
      <input type="submit" name="add-instructor" value="Add Instruction" class="btn_login waves-effect">
</div>
   </form>
         	</div>
         </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="text-center">
                ...
                <h3>Instruction added successfully</h3>
        ...
        <div class="modal-footer justify-content-center">
            ...
            <a type="button" class="btn btn-outline-success waves-effect" href="ManageDosageInstruction.php">OK</a>
        </div>
    </div>
    <!--/.Content-->
</div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <form method="post" id="deleteForm" action="../Controller/AdminController.php">
              <div class="md-form">
                 <input type="text" name="remove_instruction" id="modal-input-delete" style="display: none;" >
              </div>
             
             <div class="md-form">
               <button type="submit" name="removeInstruction" class="btn btn-danger">Remove <i class="fa fa-times ml-1"></i></button>
             </div>
            </form>
...
<script type="text/javascript" src="js/jquery-3.3.1.min.js"></script>
  ...
  <script type="text/javascript">
    function remove_instruction_modal(param1 ,param2)
{
 ...
 // //("&firstName="+fname+"&lastName="+lname+"&city="+city+"&email="+email+"&mobile="+mobile+"&Rank="+Rank+"&dob="+dob+"&requestFor=addDoctor"+"&gender="+gender+"&department="+selected_departments+"&doj="+doj);
   ...
   var datastring="instruction="+instruction+"&addInstruction="+"yes";
     $.ajax({
      type:"POST",
