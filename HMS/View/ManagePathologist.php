...
<!-- Nav tabs -->
 <ul class="nav nav-tabs nav-justified md-tabs indigo" id="myTabJust" role="tablist">
     <li class="nav-item">
         <a class="nav-link active" id="tab1" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-eye"></i> View Pathologists</a>
     </li> 
     <li class="nav-item">
         <a class="nav-link" id="tab2" data-toggle="tab" href="#panel6" role="tab"><i class="fa fa-pencil"></i> Add Pathologist</a>
     </li>
 ...
 <div class="tab-content">
    ...
    <tbody>
      <?php $admin=new AdminController();
         $row=$admin->getAllPathologists();
              foreach ($row as $pathologist_data) {
                ?>
                <tr class="text-center">
                  <td><?php echo $pathologist_data['army_no']; ?></td>
                   <td><?php echo $pathologist_data['fname']; ?></td>
                  <td><?php echo $pathologist_data['lname']; ?></td>
                  <td><?php echo $pathologist_data['mobile_no']; ?></td>
                  <td><?php echo $pathologist_data['gender']; ?></td>
                  <td><?php echo $pathologist_data['email']; ?></td>
...
<div class="md-form  col-lg-3 offset-md-4">
      ...
      <input type="submit" name="add-instructor" value="Add Pathologist" class="btn_login waves-effect">
</div>
   </form>
         	</div>
         </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="text-center">
                ...
                <h3>Pathologist registered successfully</h3>
        ...
        <div class="modal-footer justify-content-center">
            ...
            <a type="button" class="btn btn-outline-success waves-effect" href="ManagePathologist.php">OK</a>
        </div>
    </div>
    <!--/.Content-->
</div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <form method="post" id="deleteForm" action="../Controller/AdminController.php">
             ...
             <div class="md-form">
               <button type="submit" name="removePathologist" class="btn btn-danger">Remove <i class="fa fa-times ml-1"></i></button>
             </div>
