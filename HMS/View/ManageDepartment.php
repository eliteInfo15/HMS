...
<!-- Nav tabs -->
 <ul class="nav nav-tabs nav-justified md-tabs indigo" id="myTabJust" role="tablist">
     <li class="nav-item">
         <a class="nav-link active" id="tab1" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-eye"></i> View Departments</a>
     </li> 
     <li class="nav-item">
         <a class="nav-link" id="tab2" data-toggle="tab" href="#panel6" role="tab"><i class="fa fa-pencil"></i> Add Department</a>
     </li>
         ...
         $row=$admin->getAllDepartments();
              foreach ($row as $department_data) {
                ...
                <tr class="text-center">
                  ...
                  <td><?php echo $department_data['establishment_year']; ?></td>
...
<div class="md-form  col-lg-3 offset-md-4">
      ...
      <input type="submit" name="add-instructor" value="Add Department" class="btn_login waves-effect">
</div>
   </form>
         	</div>
         </div>
    ...
    function remove_department_modal(param1 ,param2)
{
 ...
 // //("&firstName="+fname+"&lastName="+lname+"&city="+city+"&email="+email+"&mobile="+mobile+"&Rank="+Rank+"&dob="+dob+"&requestFor=addDoctor"+"&gender="+gender+"&department="+selected_departments+"&doj="+doj);
   ...
   var datastring="dname="+dname+"&year="+year+"&addDepartment="+"yes";
     $.ajax({
      type:"POST",
