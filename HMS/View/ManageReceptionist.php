...
<!-- Nav tabs -->
 <ul class="nav nav-tabs nav-justified md-tabs indigo" id="myTabJust" role="tablist">
     <li class="nav-item">
         <a class="nav-link active" id="tab1" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-eye"></i> View Receptionists</a>
     </li> 
     <li class="nav-item">
         <a class="nav-link" id="tab2" data-toggle="tab" href="#panel6" role="tab"><i class="fa fa-pencil"></i> Add Receptionist</a>
     </li>
 ...
 <div class="tab-content">
    ...
    <tbody>
      <?php $admin=new AdminController();
         $row=$admin->getAllReceptionists();
              foreach ($row as $receptionist_data) {
                ?>
                <tr class="text-center">
                  <td><?php echo $receptionist_data['army_no']; ?></td>
                   <td><?php echo $receptionist_data['fname']; ?></td>
                  <td><?php echo $receptionist_data['lname']; ?></td>
                  <td><?php echo $receptionist_data['mobile_no']; ?></td>
                  <td><?php echo $receptionist_data['gender']; ?></td>
                  <td><?php echo $receptionist_data['email']; ?></td>
                   <td><?php echo $receptionist_data['rank']; ?></td>
                   <td><?php echo $receptionist_data['date_of_joining']; ?></td>
                   <td><?php echo $receptionist_data['dob']; ?></td>
                  <td>
                    <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#centralModalDanger" onclick="remove_receptionist_modal('Remove','<?php echo $receptionist_data['army_no'];?>')" >Remove</a></td>
                </tr>
                <?php
              }
...
<div class="md-form  col-lg-3 offset-md-4">
      ...
      <input type="submit" name="add-receptionist" value="Add Receptionist" class="btn_login waves-effect">
</div>
   </form>
         	</div>
         </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="text-center">
                ...
                <h3>Receptionist registered successfully</h3>
        ...
        <div class="modal-footer justify-content-center">
            ...
            <a type="button" class="btn btn-outline-success waves-effect" href="ManageReceptionist.php">OK</a>
        </div>
    </div>
    <!--/.Content-->
</div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <form method="post" id="deleteForm" action="../Controller/AdminController.php">
             ...
             <div class="md-form">
               <button type="submit" name="removeReceptionist" class="btn btn-danger">Remove <i class="fa fa-times ml-1"></i></button>
             </div>
...
<script type="text/javascript" src="js/jquery-3.3.1.min.js"></script>
  ...
  <script type="text/javascript">
    function remove_receptionist_modal(param1 ,param2)
{
 ...
 // //("&firstName="+fname+"&lastName="+lname+"&city="+city+"&email="+email+"&mobile="+mobile+"&Rank="+Rank+"&dob="+dob+"&requestFor=addDoctor"+"&gender="+gender+"&department="+selected_departments+"&doj="+doj);
   ...
   var datastring="army_no="+army_no+"&role="+role+"&password="+password+"&firstName="+fname+"&lastName="+lname+"&email="+email+"&mobile="+mobile+"&rank="+Rank+"&dob="+dob+"&addReceptionist=add"+"&gender="+gender+"&doj="+doj;
