...
<main id="dash1" class="smooth" style="padding-top: 0px;padding-left: 0px">
    ...
    <form class="" style="color: #3F51B5;" id="loginform" method="post">
        ...
        <input type="text" id="testDate" name="testDate" style="display: none" value="<?php  echo $test_date ?>">
        <div class="row">
             <div class="col-lg-6">
           <div class="md-form">
      ...
      <div class="row">
          ...
          <div class="col-lg-6" style="padding: 10px;margin-bottom: 20px;">
                     <div class="md-form" role="alert">
                          ...
                          <input type="text" class="form-control <?php echo 'attribute'.($count)?>" name="<?php echo 'attribute'.($count)?>" id="<?php echo $attribute["attribute_id"]?>"  readonly="">
      ...
      <div class="row text-center">
          <div class="md-form  col-lg-3 ">
              ...
              <input type="submit" name="add-instructor" value="Approve" class="btn_login waves-effect" style="background: #7CB342">
          ...
          <div class="md-form  col-lg-3 ">
              ...
              <input type="button"  value="Deny" class="btn_login waves-effect" id="deny" style="background: #f44336">
...
<div class="modal-dialog modal-notify modal-success" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            <a type="button" class="btn btn-outline-success waves-effect" href="OICPathologistHome.php">OK</a>
        </div>
    </div>
    <!--/.Content-->
</div>
...
<script type="text/javascript" src="js/jquery-3.3.1.min.js"></script>
  ...
  $(document).ready(function(){
      ...
      datastring="patientId="+patientId+"&getTempResult=yes";
      $.ajax({
      type:"POST",
      url:"../Controller/PathologistController.php",
      data:datastring,
     ...
     var data= JSON.parse(result);
      ...
      $("#"+data[i].attribute_id).val(data[i].value);
}
 ...
 var testData= JSON.stringify(test_result);
     var datastring="patient_id="+patient_id+"&test_id="+test_id+"&pathologistArmyNo="+pathologistArmyNo+"&testResultJson="+testData+"&addTestResult=yes";
